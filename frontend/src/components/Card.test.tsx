...
describe('Card Component', () => {
  ...
  it('renders the author information', () => {
    ...
    const authorAvatar = screen.getByAltText('avatar');
    expect(authorAvatar).toHaveAttribute('src', mockProduct.author.avatar);
  });
  ...
  it('renders the product image correctly', () => {
    ...
    const productImage = screen.getByAltText('img-icon');
